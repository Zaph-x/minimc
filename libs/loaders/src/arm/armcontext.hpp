...
//                   std::unordered_map<const ARM::Parser::Variable,MiniMC::Model::Value_ptr> values) : values(std::move(values)),cfact(cfact),tfact(tfact) {}
...
//      MiniMC::Model::Value_ptr findValue (const ARM::Parser::Variable val);
...
//      MiniMC::Model::TypeFactory& tfact;
//      Model::Type_ptr getType(ARM::Parser::DefinitionStub type);
//    };
//
...
//
//    template<class Gatherer>
//    void InstructionTranslator::operator() (ARM::P inst, Gatherer&& gather) {
//
