...
namespace MiniMC {
  namespace Loaders {
    ...
    MiniMC::Model::TypeID getTypeID(const ARM::Parser::DefinitionStub &type) {

      switch (type.get_size()){
        case 1:
          //TODO How to handle char vs bool
        ...
        default:
          ERROR("Type is unknown or unimplemented");
      }
...
//      }
    ...
    MiniMC::Model::Type_ptr GLoadContext::getType (const ARM::Parser::DefinitionStub &type ) {
